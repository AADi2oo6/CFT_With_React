    ...
    return (
        <section className="py-16 px-4 bg-gray-50">
            <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Country vs Global Average</h2>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                        ...
                        <div className="flex-grow w-full bg-gray-100 rounded-full h-12 relative overflow-hidden">
                            <div
                            ...
                            <div className="absolute inset-0 flex items-center justify-end px-4">
                                <span className="text-gray-500 font-medium">1.9 tons/year</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                        <div className="w-full md:w-48 flex items-center gap-2">
                            ...
                            <span className="text-gray-700 font-medium">Global Average</span>
                        </div>
                        <div className="flex-grow w-full bg-gray-100 rounded-full h-12 relative overflow-hidden">
                            <div
                    ...
                    <div className="pt-6">
                        <button className="text-teal-600 font-semibold border border-teal-600 rounded-lg px-6 py-3 hover:bg-teal-50 transition-colors w-full md:w-auto">
